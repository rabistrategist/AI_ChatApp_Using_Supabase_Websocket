...
export default function ChatBox() {
  ...
  const { messages, loading, isTyping, sendMessage, deleteMessage, stopGenerating, editMessage } = useChatMessages(user?.id)
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs text-green-500 font-medium">Live Streaming</span>
            </div>
          </div>
        </div>
